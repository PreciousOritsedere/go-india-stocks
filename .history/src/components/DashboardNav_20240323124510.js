...
export default function DashboardNav() {
  ...
  return (
    <div className="flex items-center">
      ...
      {/* Button container */}
      <div className={`flex items-center justify-center p-2 h-[100px] text-white bg-slate-900 focus:outline-none  rounded transition-transform duration-300 ease-in-out ${isOpen && 'transform translate-x-[15rem] z-'}`} onClick={() => setIsOpen(!isOpen)}>
