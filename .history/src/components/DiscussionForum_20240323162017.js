...
export default function DiscussionForum() {
  return (
    ...
    <div className="py-2 px-4 bg-gray-400 text-2xl text-center text-red-600 sm:hidden">
        Discussion Forum
    </div>
        ...
        >
            ...
            <div className="flex flex-col gap-2">
              <div className="w-full flex items-center justify-between">
                <div className="w-[70%] flex items-center gap-2.5">
                  ...
                  <p className=" px-2 py-1 bg-blue-900 text-xs rounded-full text-white">
                    {discussion.sector}
                  </p>
                </div>
          ...
          <div className="flex items-center justify-between mt-4">
            <div className="w-full flex items-center justify-between text-xs">
              ...
              <span className="flex items-center gap-1 text-gray-500">
                <Image src={Share} alt="comment icon" />
                Share
              </span>
            </div>
          </div>
