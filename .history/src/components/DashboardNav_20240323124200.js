...
export default function DashboardNav() {
  ...
  return (
    <div className="flex items-center">
      ...
      {/* Button container */}
      <div className={`flex items-center m-2 p-2 h-[100px] text-white bg-slate-900 focus:outline-none  rounded-md transition-transform duration-300 ease-in-out ${isOpen && 'transform translate-x-[15rem]'}`} onClick={() => setIsOpen(!isOpen)}>
