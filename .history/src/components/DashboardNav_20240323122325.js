...
export default function DashboardNav() {
  return (
    ...
    <div 
      className={`bg-blue-800 text-white fixed inset-y-0 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out flex flex-col`}
