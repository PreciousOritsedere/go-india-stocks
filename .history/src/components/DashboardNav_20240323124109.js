...
export default function DashboardNav() {
  ...
  return (
    <div className="flex items-center">
      ...
      {/* Button container */}
      <div className={` m-2 p-2 h-[40px] text-white bg-slate-900 focus:outline-none  rounded-md transition-transform duration-300 ease-in-out ${isOpen && 'transform translate-x-[15rem]'}`}>
        <button
